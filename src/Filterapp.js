...
import { brands, filterByBrand, getSneakerById, SNEAKERS,categories } from "./routercategory/data";
...
function BrandLink({ category, children, ...props }) {
      ...
      <nav>
        ...
        <ul>
          ...
          {categories.map((category) => (
            <li key={category}>
              <BrandLink category={category}>{category}</BrandLink>
            </li>
          ))}
        </ul>
      </nav>
